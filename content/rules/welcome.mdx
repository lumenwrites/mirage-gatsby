...
Mirage can be played online and in-person. Join our [Discord Community](https://discord.gg/zt4N23d) to play online, and go <Link to="/pen-and-paper">here</Link> to get all you need to play the pen-and-paper version.
...
If this sounds exciting - go read the <Link to="/rules">rules</Link> (don't worry, they're short and simple), and then join our [discord community](https://discord.gg/zt4N23d) to find people you can play with.
